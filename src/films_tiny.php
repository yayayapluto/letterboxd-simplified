...
>>>>>>> f1e8e3b59870a6876ec48e23990c1e970a7618bf
<!DOCTYPE html>
...
<<<<<<< HEAD
    ...
    <main class="container mx-auto">
        <?php include_once('./component/film_header.php') ?>
        <hr class="my-3">
        ...
        <div id="movies-list" class="w-full grid grid-cols-12 auto-rows-auto gap-3">
